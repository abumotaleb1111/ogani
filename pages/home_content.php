<?php 
  ...
  $queryResult = $application->getTwelvePublishedProductInfo();
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="admin/<?php echo $productInfo['product_image']; ?>">
                            <ul class="featured__item__pic__hover">
                                <!-- <li><a href="#"><i class="fa fa-heart"></i></a></li> -->
                                <li><a href="product-details.php?id=<?php echo $productInfo['id'];  ?>"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                        </div>
                        <div class="featured__item__text">
                            <h6><a href="#"><?php echo $productInfo['product_name']; ?></a></h6>
                            <h5><?php echo $productInfo['product_price']; ?> /-</h5>
                        </div>
                    </div>
                </div>
                <?php } ?>
                            ...
                            <div class="latest-prdouct__slider__item">
                                <a href="#" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="assets/frontend/img/latest-product/cart-2.jpg" alt="">
                                    </div>
                                ...
                                <a href="#" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="assets/frontend/img/latest-product/cart-3.jpg" alt="">
                                    </div>
                                    <div class="latest-product__item__text">
                                        <h6>Crab Pool Security</h6>
                                        <span>$30.00</span>
                                ...
                                <a href="#" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="assets/frontend/img/latest-product/cart-1.jpg" alt="">
                                    </div>
                                    <div class="latest-product__item__text">
                                        <h6>Crab Pool Security</h6>
                                        <span>$30.00</span>
